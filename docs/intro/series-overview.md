...
![Series dependency map — all posts and how they connect](../assets/intro/series-overview.svg)
...
![Three reading paths — enthusiast, student, engineer](../assets/intro/reading-paths.svg)
