# Post-PDU Paralleling: Safely Connecting Battery Packs in Parallel
...
![Parallel pack schematic](../../assets/codex_assetsplan/post-pdu-paralleling/parallel-pack-schematic.svg)

## Main Risk: Inrush and Voltage Mismatch

When bus voltages differ, high transient current can flow immediately at connection.

![Inrush current waveform](../../assets/codex_assetsplan/post-pdu-paralleling/inrush-current-waveform.svg)
![Voltage match tolerance band](../../assets/codex_assetsplan/post-pdu-paralleling/voltage-match-band.svg)

## Controlled Connection Strategy

Use pre-charge and sequence control before closing main parallel contact paths.

![Pre-charge sequence timeline](../../assets/codex_assetsplan/post-pdu-paralleling/precharge-sequence-timeline.svg)

## Current Sharing Reality

Parallel sharing depends on branch resistance and dynamic impedance.

![Current sharing vs resistance mismatch](../../assets/codex_assetsplan/post-pdu-paralleling/current-sharing-vs-resistance.svg)
