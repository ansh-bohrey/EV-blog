...
![BMS state machine: Sleep → Standby → Pre-charge → Active/Run → Charge → Fault](../assets/claude_assetsplan/bms-concepts/bms-state-machine.svg)
...
<iframe src="../assets/claude_assetsplan/bms-concepts/precharge-rc-curve.html" width="100%" height="380" frameborder="0"></iframe>
