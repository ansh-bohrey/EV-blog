...
![Thermal runaway cascade — SEI decomposition (~80–100°C), anode/electrolyte reaction (~100–130°C), separator damage (~130–150°C), cathode O₂ release (~150–200°C for layered oxides; ~250°C+ for LFP), electrolyte combustion (>200°C) — representative for NMC cells at moderate SOC; Feng et al. 2018](../assets/bms-concepts/thermal-runaway-cascade.svg)
